(function (global, factory) {
  ...
  (global = global || self, factory(global.espree = {}));
  ...
  Object.defineProperty(module.exports, "tokTypes", {
    get: function get_tokTypes() {
      return getJsxTokens(acorn$1).tokTypes;
    },
    configurable: true,
    enumerable: true
  });
  ...
  function plugin(options, Parser) {
    const acorn = Parser.acorn || acorn$1;
  ...
  TokenTranslator.prototype = {
      ...
      translate(token, extra) {
          ...
          if (type === tt.name) {
              token.type = Token$1.Identifier;

              // TODO: See if this is an Acorn bug
              if (token.value === "static") {
                  token.type = Token$1.Keyword;
              }
              ...
              token.type = Token$1.Punctuator;
              token.value = this._code.slice(token.start, token.end);
          } else if (type === tt.jsxName) {
              token.type = Token$1.JSXIdentifier;
          } else if (type.label === "jsxText" || type === tt.jsxAttrValueToken) {
              token.type = Token$1.JSXText;
          } else if (type.keyword) {
              if (type.keyword === "true" || type.keyword === "false") {
                  token.type = Token$1.Boolean;
              } else if (type.keyword === "null") {
                  token.type = Token$1.Null;
              } else {
                  token.type = Token$1.Keyword;
              }
          } else if (type === tt.num) {
              token.type = Token$1.Numeric;
              token.value = this._code.slice(token.start, token.end);
              ...
              if (extra.jsxAttrValueToken) {
                  ...
                  token.type = Token$1.String;
              }

              token.value = this._code.slice(token.start, token.end);
          } else if (type === tt.regexp) {
              token.type = Token$1.RegularExpression;
  ...
  var _from = "espree";
  var _id = "espree@6.2.1";
  var _inBundle = false;
  var _integrity = "sha512-ysCxRQY3WaXJz9tdbWOwuWr5Y/XrPTGX9Kiz3yoUXwW0VZ4w30HTkQLaGx/+ttFjF8i+ACbArnB4ce68a9m5hw==";
  var _location = "/espree";
  ...
  var _resolved = "https://registry.npmjs.org/espree/-/espree-6.2.1.tgz";
  var _shasum = "77fc72e1fd744a2052c20f38a5b575832e82734a";
  var _spec = "espree";
  ...
  const parsers = {
      ...
      get regular() {
          if (this._regular === null) {
              this._regular = acorn$1.Parser.extend(espree());
          }
      ...
      get jsx() {
          if (this._jsx === null) {
              this._jsx = acorn$1.Parser.extend(acornJsx(), espree());
          }
          return this._jsx;
      },
  ...
  var version$2 = require$$1.version;
  ...
  exports.default = espree_1;
  exports.latestEcmaVersion = latestEcmaVersion;
  exports.parse = parse_1;
  exports.supportedEcmaVersions = supportedEcmaVersions;
  exports.tokenize = tokenize_1;
